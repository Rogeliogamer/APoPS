...
<head>
    ...
    <title>Experimento de Relaciones - BD</title>
    ...
    <style>
        ...
        .dashboard-panel h3 { margin-top: 0; color: #111827; font-size: 18px; }
...
<body>
    ...
    <div class="dashboard-panel">
        ...
        <div class="legend-item"><div class="square" style="background:#00cc66"></div> Sol. Aprobada</div>
        <div class="legend-item"><div class="square" style="background:#ffaa00"></div> Sol. Pendiente</div>
        <div class="legend-item"><div class="square" style="background:#ff4444"></div> Sol. Rechazada</div>
        ...
        <a href="menu.cfm" class="btn-back">← Volver al Menú</a>
    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            // Cargar datos
            $.ajax({
                url: 'componentes/grafoData.cfc?method=getDatosGrafo',
                method: 'GET',
                dataType: 'json',
