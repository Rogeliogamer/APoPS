                    ...
                    <div class="submit-section">
                        ...
                        <cfif totalPages GT 1>
                            ...
                            <cfif startPage GT 1>
                                ...
                                <cfoutput>
                                    <a href="listaUsuariosEliminar.cfm?page=#prevPage#&search=#urlEncodedFormat(searchTerm)#"
                            ...
                            <cfloop from="#startPage#" to="#endPage#" index="i">
                                ...
                                <cfelse>
                                    <cfoutput>
                                        <a href="listaUsuariosEliminar.cfm?page=#i#&search=#urlEncodedFormat(searchTerm)#" 
                            ...
                            <cfif endPage LT totalPages>
                                ...
                                <cfoutput>
                                    <a href="listaUsuariosEliminar.cfm?page=#nextPage#&search=#urlEncodedFormat(searchTerm)#"
