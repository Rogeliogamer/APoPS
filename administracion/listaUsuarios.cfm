    ...
    <body>
        ...
        <cfquery name="qUsuarios" datasource="autorizacion">
            ...
            <cfif len(trim(form.search))>
                AND (
                    u.id_usuario LIKE <cfqueryparam value="%#form.search#%" cfsqltype="cf_sql_varchar">
                    OR u.usuario LIKE <cfqueryparam value="%#form.search#%" cfsqltype="cf_sql_varchar">
                    OR u.rol LIKE <cfqueryparam value="%#form.search#%" cfsqltype="cf_sql_varchar">
                    OR u.activo LIKE <cfqueryparam value="%#form.search#%" cfsqltype="cf_sql_varchar">
                    OR (CASE WHEN u.activo = 1 THEN 'Sí' ELSE 'No' END) LIKE <cfqueryparam value="%#form.search#%" cfsqltype="cf_sql_varchar">
                    OR u.activo LIKE <cfqueryparam value="%#form.search#%" cfsqltype="cf_sql_varchar">
