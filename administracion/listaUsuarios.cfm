<!---
 * Nombre de la pagina: administracion/listaUsuarios.cfm
 * 
 * Descripción: 
 * Esta página muestra una lista paginada de usuarios registrados en el sistema.
 * Incluye un formulario de búsqueda que permite filtrar usuarios por varios campos,
 * como ID, nombre, apellidos, área, rol y estado activo.
 * Solo los administradores tienen acceso a esta página.
 * 
 * Roles:
 * Admin: Acceso completo para ver la lista de usuarios.
 * 
 * Paginas relacionadas:
 * login.cfm - Página de inicio de sesión.
 * menu.cfm - Menú principal del sistema.
 * listaUsuarios.cfm - Esta misma página para la funcionalidad de búsqueda y paginación.
        ...
        <cfquery name="qUsuarios" datasource="autorizacion">
            ...
            <cfif len(trim(searchTerm))>
                AND (
                    ...
                    OR u.activo LIKE <cfqueryparam value="%#searchTerm#%" cfsqltype="cf_sql_varchar">
                    OR (CASE WHEN u.activo = 1 THEN 'Sí' ELSE 'No' END) LIKE <cfqueryparam value="%#searchTerm#%" cfsqltype="cf_sql_varchar">
                    ...
                    <div class="form-field">
                        ...
                        <cfoutput>
                            ...
                            <input type="text" 
                                ...
                                placeholder="Usuario, Nombre, Apellidos, Área, etc.">
                        </cfoutput>
                    </div>
                    ...
                    <div class="table-responsive-custom">
                        ...
                        <table class="tabla">
                            ...
                            <tr class="titulos-tabla">
                                ...
                                <td class="titulo-general">Activo</td>
